...
// 1. Caller가 Callee에게 요청 시 Caller의 팝업 화면 
...
// 2. Callee에게 요청 들어온 Chat 또는 Video를 수락 또는 거절할지 띄우는 화면
export const showIncomingCallDialog = (
  callType, 
  acceptCallHandler, 
  rejectCallHandler
  ) => {
    const callTypeInfo = callType === constants.callType.CHAT_PERSONAL_CODE ? "Chat" : "Viedo";
...
export const showNoStrangerAvailableDislog = () => {
